    ...
    >
      <div className={"hero"} style={{ margin: "auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <Nav style={{ marginRight: "1em" }} className={"flex-column"}>
            ...
            <Nav.Item>
              <NewTabLink
                type={TabType.Filesystem}
                text={"Filesystem Find & Replace"}
                style={{ padding: 0 }}
              />
            </Nav.Item>
          </Nav>
      ...
      <div>
        ...
        >
          ...
          <Nav.Item>
            <Nav.Link href={"https://comby.dev/"} target={"_blank"}>
              comby.dev
            </Nav.Link>
          </Nav.Item>
          <Navbar.Brand>modeled after</Navbar.Brand>
          <Nav.Item>
            <Nav.Link href={"https://comby.live/"} target={"_blank"}>
              comby.live
            </Nav.Link>
          </Nav.Item>
        </Nav>
